...
Na grafu vidíme, že červenočerný strom potřebuje na operaci konzistentně přibližně $(\log
...
Nyní se ale ještě na chvíli vrátíme k~výpočtům. Již víme, že asociativita cache
...
\ope{Insert} provádíme podle Sleatora a Tarjana \citeyearpar{splay} 3 typy kroků: přebarvení černého vrcholu na červený a obou
...
Tím jsme tedy ukázali, že náš červenočerný strom trpí problémy s~asociativitou cache téměř stejnou měrou, jako kdyby byl dokonale vyvážený.
...
Pokud $k < 10^5$, vejde se celá relevantní část stromu do cache. Když
