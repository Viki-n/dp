...
rezervou stačí k tomu, abychom operacemi \ope{Splay} přesunuli všechny prvky,
...
obrázcích \ref{touch_i} a \ref{time_i}. To není příliš překvapivé -- všechny
...
\includegraphics[width=.65\hsize]{graphs/#1_touch_#2}
\hskip -.5cm
\includegraphics[width=.65\hsize]{graphs/#1_time_#2}
\hss}
\caption{#3}
\label{obr:#1_#2}
\end{figure}
