...
lineární vzhledem k zřetězení. Jinýmy slovy, budeme požadovat, aby pro každé dvě přístupové posloupnosti $S$, $T$ $g(S) + g(T)\geq
...
posloupnostem se také říká \emph{bit reversal posloupnosti}. Na druhou stranu
ZDROJ ukázal, že pro žádný pevný strom $T$ nedává Interleave bound těsný odhad
pro ksždou přístupovou posloupnost $S$. Zda pro každou posloupnost $S$ existuje
