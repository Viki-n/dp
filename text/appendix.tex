...
implementaci zásobníku. Zásobník předpokládá, že před jeho vložením do zdrojového kódu budou nadefinována následující objektová makra, jejichž expanzí budou validní identifikátory jazyka C:
...
potřebný pro vykonání operace \ope{Splay}, protože po této operaci chceme v
...
množství milisekund strávených operacemi \ope{Find}.
